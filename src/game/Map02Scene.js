...
export default class Map02Scene extends Phaser.Scene {
  ...
  async playIntro() {
    ...
    await GameUI.say([
      ...
      "루미: 오래된 책들이 말을 잃고 잠들어 있어.",

      "나: 여기에도 언어 수정의 조각이 있는 거지?",

      "루미: 응. 도서관의 마법 장치들을 깨우면 찾을 수 있을 거야.",
  ...
  async handleMagicCircle() {
    ...
    await GameUI.say([
      ...
      "마법진의 빛이 도서관 오른쪽으로 흘러갔다.",

      "나: 저 캐비닛의 자물쇠가 풀린 것 같아.",
